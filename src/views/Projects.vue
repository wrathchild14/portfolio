  ...
  data() {
    return {
      ...
      projects: [
        ...
        {
          title: "Website",
          description: "Developed a website using MVC, php and MySQL for the database.",
        ...
        },
        {
          ...
          description: "In java, I had played around and developed the following data strucutres: Tree23, Binary Search Tree, Hash Tree, SkipList...",
        ...
        {
          title: "Game",
          description: "Developed a game in WebGL, which i called RipNOff. To play it press on Game on the left menu",
          img: "ripnoff.png",
          show: false,
